/**
 * Character & Vault Helper Utilities Module
 *
 * Shared functions for character creation and vault management.
 * Provides vault generation and location name lookups.
 *
 * @module utils/characterHelpers
 */
...
if (typeof window !== 'undefined') {
  ...
  window.getVaultBuildingForLocation = getVaultBuildingForLocation;
  window.getDisplayNamesForLocation = getDisplayNamesForLocation;
}

logger.debug('Character helpers module loaded');
