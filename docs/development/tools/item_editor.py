...
class AdvancedItemEditor:
    ...
    def load_items(self):
        ...
        # Navigate from docs/development/tools to project root, then to docs/data/equipment/items
        items_dir = script_dir.parent.parent.parent / "docs" / "data" / "equipment" / "items"
    ...
    def load_item_image(self, img_path):
        ...
        script_dir = Path(__file__).parent
        # Navigate from docs/development/tools to project root
